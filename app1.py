...
REPO_NAME = "Abdullahshade/NIHApp"  # Replace with your GitHub repository name
FILE_PATH = "Pneumothorax_AP_metadata.csv"  # Path to metadata CSV in your GitHub repo
repo = g.get_repo(REPO_NAME)

# Define the paths
images_folder = "outputimages0"  # Path to your images folder (update as needed)
csv_file_path = "Pneumothorax_AP_metadata.csv"  # Path to your CSV file (update as needed)
